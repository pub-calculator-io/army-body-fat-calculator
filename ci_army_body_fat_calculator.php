...
Version: 1.0.0
Author: Army Body Fat Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Army Body Fat Calculator by www.calculator.io";

function display_calcio_ci_army_body_fat_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_army_body_fat_calculator', 'display_calcio_ci_army_body_fat_calculator' );